...
import 'package:todo/UI/screens/list_screen.dart';
import 'package:todo/UI/screens/setting_screen.dart';
          ...
          children: [
            ...
            Form(
              ...
              child: Column(
                children: [
                  TextFormField(
                    style: provider.isDark ? TextStyle(color: Colors.white) : TextStyle(color: Colors.black),
                    controller: taskName,
                    validator: (text) {
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          if (formKey.currentState?.validate() == true) {
                            ...
                            print("Task Name : ${taskDetails.text}");
